...
public:
   ...
   */
  virtual int accept(int sockfd, sockaddr* addr, socklen_t * addrlen) PURE;

  /**
   * @see connect (man 2 connect)
   */
  virtual int connect(int sockfd, const sockaddr* addr, socklen_t addrlen) PURE;
   ...
   */
  virtual int setsockopt(int sockfd, int level, int optname, const void* optval, socklen_t optlen) PURE;
   ...
   */
  virtual int getsockname(int sockfd, struct sockaddr *paddr, socklen_t *paddrlen) PURE;

  /**
   * @see man 2 getpeername
   */
  virtual int getpeername(int sockfd, struct sockaddr *paddr, socklen_t *paddrlen) PURE;
    
  /**
   * @see man 2 knl socket
   */
  virtual int socket(int domain, int type, int protocol) PURE;

  /**
   * @see man 2 usr socket
   */
  virtual int socket2(int domain, int type, int protocol) PURE;
