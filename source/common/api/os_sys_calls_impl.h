...
public:
  ...
  int accept(int sockfd, sockaddr* addr, socklen_t* addrlen) override;
  ...
  int getsockname(int sockfd, struct sockaddr *paddr, socklen_t *paddrlen) override;
  int getpeername(int sockfd, struct sockaddr *paddr, socklen_t *paddrlen) override;
  int socket(int domain, int type, int protocol) override;
  int socket2(int domain, int type, int protocol) override;
};
